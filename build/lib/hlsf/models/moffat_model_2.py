...
class MOFFAT_MODEL_2(LSF_MODEL):
    ...
    def __init__(self, lsf_data, listLines=None, _coeff=None) -> None:
        ...
        if (_coeff == None):
            ...
            popt = [[popt[0], popt[1]], [popt[2], popt[3]], [popt[4], popt[5]], [popt[6], popt[7]]]
            self._coeff = dict(zip(['amplitude', 'center', 'sigma', 'beta'], popt))
    ...
    def evaluate_intensity(self, w_0, waves):
        ...
        eval_intensity = poly_moffat(waves-w_0, w_0, *coeff)
